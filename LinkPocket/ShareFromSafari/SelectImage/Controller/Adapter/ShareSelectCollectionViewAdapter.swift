//
//  ShareSelectCollectionView.swift
//  ShareFromSafari
//
...
protocol ShareSelectCollectionViewAdapterDelegate {
    func collectionViewCellDidClicked(image: UIImage)
}

class ShareSelectCollectionViewAdapter: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, LPHtmlParserDelegate {
    ...
    var delegate: ShareSelectCollectionViewAdapterDelegate?
